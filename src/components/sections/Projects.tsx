...
const projects: Project[] = [
  {
   ...
   {
    name: 'InsightPilot',
    description: 'Built InsightPilot, a LangGraph-based multi-agent analytics system that converts natural-language queries into validated SQL and executed insights. It integrates LLMs for query understanding, SQL generation, and result summarization, enabling users to derive insights from databases using natural language.',
    technologies: [' LangGraph (ReAct), Render, Groq API, SQLAlchemy, FastAPI(Python),Vercel'],
    image: '/images/insightpilot.png',
    dataAiHint: 'ai agent',
    liveDemo: 'https://insightpilotai.vercel.app/',
    githubLink: 'https://github.com/zenitsu0509/InsightPilot', 
  },
  {
